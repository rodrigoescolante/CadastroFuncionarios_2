    ...
    .AddJwtBearer(options =>
    {
        ...
        options.Events = new JwtBearerEvents
        {
            OnChallenge = context =>
            {
                ...
                context.Response.WriteAsync("Operação não autorizada. Faça login e digite o token gerado no campo Authorizate.");
...
builder.Services.AddDbContext<Db>(option => {option.UseSqlServer(builder.Configuration.GetConnectionString("ConexaoDb"));});
